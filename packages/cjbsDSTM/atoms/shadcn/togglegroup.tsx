...
export const ToggleGroup = forwardRef<
	...
	VariantProps<typeof toggleVariants>
>(({ className, variant, size, children, ...props }, ref: ForwardedRef<ElementRef<typeof Root>>)=>(
	<Root
		ref={ref}
		className={cn(
...
export const ToggleGroupItem = forwardRef<
	...
	VariantProps<typeof toggleVariants>
>(({ className, variant, size, children, ...props }, ref: ForwardedRef<ElementRef<typeof Item>>)=>{
