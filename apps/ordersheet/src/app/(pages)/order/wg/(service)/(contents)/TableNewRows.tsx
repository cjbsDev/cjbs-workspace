...
import { IconButton, TableCell, TableRow, Typography, Stack } from "@mui/material";
...
const TableNewRows = (props:any) => {
  ...
  const { field, remove, index, errors, serviceType, groupOptionData } = props;

  // const groupCmprAnlsListGV = [
  //   { value: "test1", optionName: "test1" },
  //   { value: "test2", optionName: "test2" },
  //   { value: "test3", optionName: "test3" },
  // ];
