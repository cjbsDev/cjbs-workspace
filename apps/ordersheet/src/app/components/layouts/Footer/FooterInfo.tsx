...
import {Box, Button, Chip, Divider, Grid, Menu, MenuItem, Stack, Typography} from '@mui/material';
...
const FooterInfo = (props: FooterInfoProps) => {
    ...
    return (
        <Grid item xs={12} sx={{mt:2, display: 'flex', justifyContent: 'space-between'}}>
            ...
            <Box sx={{display: 'flex', justifyContent: 'space-between', width:'240px'}}>
                <Image src={fbIcon} alt='fbIcon' width={30} />
                <Image src={lkIcon} alt='lkIcon' width={30} />
                <Image src={twIcon} alt='twIcon' width={30} />
                <PopupState variant="popover" popupId="demo-popup-menu">
                    {(popupState) => (
                        <React.Fragment>
                            <OutlinedButton
                                sx={{ width: "100px", color:'#FFFFFF', height: '30px', borderColor: '#FFFFFF' }}
                            ...
                            <Menu {...bindMenu(popupState)}>
                                <MenuItem onClick={popupState.close}>www.cjbioscience.com</MenuItem>
                                <MenuItem onClick={popupState.close}>www.ezbiocloud.net</MenuItem>
                                <MenuItem onClick={popupState.close}>www.truebacid.com</MenuItem>
                            </Menu>
                        </React.Fragment>
                    )}
                </PopupState>
