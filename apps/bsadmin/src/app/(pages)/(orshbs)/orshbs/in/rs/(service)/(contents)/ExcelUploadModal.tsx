    ...
    try {
      if (file) {
        ...
        const response = await POST_MULTIPART(
          `/orsh/bs/intn/rs/${serviceType}/sample`,
          formData
        ); // API 요청
        ...
        >
          ...
          {serviceType === 'fs' ? (
            ...
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/bs/url?alias=rsfssamplet`}
              iconName="xls3"
            />
          ) : ('')}
          ...
          {serviceType === 'ngs' ? (
            ...
            // </Link>
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/bs/url?alias=rsngssamplet`}
              iconName="xls3"
            />
          ) : ('')}
          ...
          {serviceType === 'so' ? (
            ...
            // </Link>
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/bs/url?alias=rssosamplet`}
              iconName="xls3"
            />
          ) : ('')}
