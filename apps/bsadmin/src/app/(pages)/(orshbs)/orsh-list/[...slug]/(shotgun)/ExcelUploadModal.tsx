  ...
  const handleFileChange = async (event) => {
    ...
    try {
      if (file) {
        ...
        //   }
        // );
        // `${process.env.NEXT_PUBLIC_API_URL_ORSH}/bs/extn/sg/${serviceType}/sample`,
        const response = await POST_MULTIPART(
          `/orsh/bs/extn/sg/${serviceType}/sample`,
          formData
        );
        ...
        >
          ...
          {serviceType === 'fs' ? (
            ...
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/orsh/url?alias=sgfssamplet`}
              iconName="xls3"
            />
          ) : ('')}
          ...
          {serviceType === 'ao' ? (
            ...
            // </Link>
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/orsh/url?alias=sgaosamplet`}
              iconName="xls3"
            />
          ) : ('')}
          ...
          {serviceType === 'so' ? (
            ...
            // </Link>
            <SampleTempleteExcelDownloadBtn
              exportUrl={`/file/orsh/url?alias=sgsosamplet`}
              iconName="xls3"
            />
          ) : ('')}
