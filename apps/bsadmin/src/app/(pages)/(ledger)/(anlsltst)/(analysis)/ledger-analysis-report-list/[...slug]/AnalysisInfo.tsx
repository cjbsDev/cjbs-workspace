...
const AnalysisInfo = () => {
  ...
  const { agncUkey, custUkey } = data.anlsItstCustInfo;
  ...
  const defaultValues = {
    ...
    remainingAmount: data.anlsItstCalculationInfo.remainingAmount
      .toString()
      .replace(/\B(?=(\d{3})+(?!\d))/g, ","),
  };
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TD sx={{ width: "85%", textAlign: "left" }}>
                    <Typography variant="body2" sx={{ pl: "14px" }}>
                      Analysis
                    </Typography>
                    <InputValidation
                      sx={{ display: "none" }}
                                      ...
                                      <TD sx={{ width: "25%" }}>
                                        ...
                                        {isPrePymt === "U" && (
                                          ...
                                          >
                                            분석내역서 번호
                                            <Link
                                              href={`/ledger-analysis-report-list/${anlsItstUkey}`}
                                            >
                                              <LinkButton
                                                buttonName={
                                                  "(" + anlsItstId + ")"
