    ...
    >
      ...
      >
        ...
        <Grid item xs={12} sx={{ display: "flex", justifyContent: "end" }}>
          ...
          <CJFontBodyBox sx={{fontSize:10}} >{tdstData.wdtDate}</CJFontBodyBox>
        </Grid>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TD sx={{ width: "40%", height: "20px", p:0, paddingX: 1 }} colSpan={1} align="center">
                    <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={0}>
                      <Stack direction="row" justifyContent="center" alignItems="center" spacing={0}>
                        <CJFontTdBox sx={{fontSize:10}} >{tdstData.conm}</CJFontTdBox>
                      </Stack>
                ...
                <TableRow>
                  ...
                  <TD sx={{ width: "40%", height: "20px", p:0, paddingX: 1 }} align="center">
                    <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={0}>
                      <Stack direction="row" justifyContent="center" alignItems="center" spacing={0}>
                        <CJFontTdBox sx={{fontSize:10}} >{tdstData.nm}</CJFontTdBox>
                      </Stack>
                ...
                <TableRow>
                  ...
                  <TD sx={{ width: "40%", height: "20px", p:0 }} colSpan={1} align="center">
                    <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={0}>
                      <CJFontTdBox sx={{fontSize:10, pl:1}} >{tdstData.tel}</CJFontTdBox>
                    </Stack>
                  </TD>
                </TableRow>
                <TableRow>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TD sx={{ width: "100%", borderBottom: 0, p:0 }} colSpan={5}>
                    <Box sx={{ minHeight: "430px", maxHeight: "430px" }}>
                      <TableContainer>
                        <Table>
                          <TableBody>
                            {productValue.map((item: any) => {
                              return (
                                <TableRow>
                                  <TD sx={{ width: "50%", border: 0, p:0, height:'20px' }}>
                                    <Box>
                                  ...
                                  <TD sx={{ width: "10%", border: 0, p:0, height:'20px' }}>
                                    <Box>
                                  ...
                                  <TD sx={{ width: "20%", border: 0, p:0, height:'20px' }}>
                                    <Box>
