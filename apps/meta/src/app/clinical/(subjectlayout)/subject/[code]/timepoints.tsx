...
const TimePoints: FunctionComponent<TimePointsProps> = ({
  timePoints,
  active,
  parents,
}) => {
            ...
            {timePoint.categories &&
              timePoint.categories.map((category, index) => (
                <Box key={`timepoints-main-${index}`}>
                  {((category.name === active && timePoint.label === parents) ||
                    (active === 'All' && timePoint.label === parents)) && (
                    <ContentsBox>
                      <Box sx={{ width: '100%' }}>
                        <Box key={index} sx={{ width: '100%' }}>
                          ...
                          <Box key={`timepoints-${index}`}>
                            ...
                            >
                              <Typography variant='subtitle2'>{timePoints.label}</Typography>
                            </FlexBox> */}
